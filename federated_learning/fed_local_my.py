...
def get_fed_local_vlm_sft_trainer(script_args, fed_args, model, tokenizer, training_args, local_dataset, data_collator, global_dict, local_auxiliary, global_auxiliary):
...
class VLMTrainer(Trainer):
    def __init__(self, model, tokenizer,args,train_dataset, data_collator):
